        ...
        return (
            <React.Fragment>
                <div class="container" style={{backgroundColor: '#ffffff', padding: '20px', paddingBottom: '40px'}}>
                    <h3 style={{color: '#042A9B', paddingTop: '30px', textAlign: 'center', fontSize: '30px', paddingBottom: '20px'}}>STEP 4 - Next of Kin</h3>
                    <div class="row">                                
                        <div class="col-lg-7">
                            <form>
                                ...
                                <div class="row row-field">
                                    <div class="col-md-6">
                                        <label>Address</label>
                                        <textarea rows={3} style={{resize: 'none'}} type="text" class="form-control" />
                                    </div>
                                    <div class="col-md-6">
                                        <label>Gender</label>
                                        <div>
